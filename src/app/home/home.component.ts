...
export class HomeComponent implements OnInit{
  constructor(private loteserv:LoteService,private detalleServ:DetalleService,private route:Router,private toastr:ToastrService,private clienteServ:ClienteService,private productoServ:ProductoService, public dialog: MatDialog){}
  ...
  ngOnInit(){
    ...
    this.detalleServ.mayorventasmes(this.mes,this.gestion).subscribe(data=>{
      this.single1=data
    })
    this.detalleServ.mayorventassemana(this.dia,this.mes,this.gestion).subscribe(data=>{
      this.single2=data
    })
    this.loteserv.productosporvencer(this.dia,this.mes,this.gestion).subscribe(data => {
